        ...
        <div class="lg:w-2/3 w-full mx-auto overflow-auto">
            ...
            <table class="table-auto w-full text-left whitespace-no-wrap">
                ...
                @foreach ($books as $books)
                    ...
                    <td class="px-4 py-3">
                        <a href="/admin/books/{{ $books->slug }}"><img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{ $books->cover }}"></a>
                    </td>
                    <td class="px-4 py-3"><a href="/admin/books/{{ $books->slug }}">{{ $books->name }}</a></td>
                    <td class="px-4 py-3">R${{ $books->price }}</td>
                    <td class="px-4 py-3">{{ $books->stock }}</td>
                    <td class="px-4 py-3 text-sm text-right space-x-3 text-gray-900">
                        <a class="mt-3 text-indigo-500 inline-flex items-center" href="/admin/books/{{ $books->slug }}/edit">Editar</a>
