        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('admin.team') }}" :active="request()->routeIs('admin.team')">
                        {{ __('Equipe') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('admin.security') }}" :active="request()->routeIs('admin.security')">
                        {{ __('Segurança') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('admin.data-imigration') }}" :active="request()->routeIs('admin.data-imigration')">
